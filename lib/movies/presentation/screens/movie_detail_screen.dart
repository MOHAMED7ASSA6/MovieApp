...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    getIt<MovieDetailsBloc>()..add(GetMovieDetailsEvent(id))..add(GetMovieRommendationEvent(id))
      ,
    lazy: false,
    child:  Scaffold(
...
class MovieDetailContent extends StatelessWidget {
                      ...
                      background: FadeIn(
                        ...
                        child: ShaderMask(
                          ...
                          child: CachedNetworkImage(
                            ...
                            imageUrl: ApisConstance.imageUrl(state.movieDetails!.backdroppath),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
  ...
  String _showGenres(List<Genreids> genres) {
    String result = '';
       ...
       delegate: SliverChildBuilderDelegate(
           ...
           return FadeInUp(
             ...
             child: ClipRRect(
               ...
               child: CachedNetworkImage(
                 imageUrl: ApisConstance.imageUrl(recommendation.backdropPath!),
